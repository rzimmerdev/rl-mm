...
\section{Definição do Problema, Desafios e Possíveis Técnicas a serem utilizadas}
\label{section:problem_description}
\input{text/problem_description} 

\section{Trabalhos Prévios e Bibliografia}
\label{section:previous_works}
\input{text/previous_works}
...
\input{text/methodology/methodology}
